...
public class Assignment_os2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("enter the initial number");
         ...
         while (true) {
            System.out.println("1-scan_scheduling 2-c_scan_scheduling 3-c_look_scheduling");
    ...
    public static void scan_scheduling(Vector<Integer>vect,int initial){
         int total_head=0,temp,max,index=0;
         vect.add(initial);
         Collections.sort(vect);
  
 max=vect.get(vect.size()-1);
  for(int t=0;t<vect.size();t++)   // to find loc of initial in array
 {
